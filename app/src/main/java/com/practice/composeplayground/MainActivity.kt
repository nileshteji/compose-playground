  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContent {
      ComposePlaygroundTheme(darkTheme = true) {
        val list = listOf("Nilesh Teji", "Anush Paulekar", "Daksh Jain", "Dinesh Songra", "Damanpreet Singh")
        PreviewFunction(list)
      }
    }
  }
}
...
fun CircularRoundImage(changeColor: Boolean, data: List<String>) {
  Card(
    ...
    Box {
      ...
      Text(
        text = data[0], fontWeight = FontWeight.Bold, color = Color.Cyan, modifier = Modifier
          .wrapContentSize()
